...
var source = '<div class="oprate"><p>\u6587\u7AE0\u603B\u6570{{posts.length}}</p>\n{{#if posts}}\n<ul>\n    {{#each posts}}\n    <li>\n        {{this.id}} -----------------{{this.title}}\n    </li>\n    {{/each}}\n</ul>\n{{/if}}\n<p>\u7528\u6237\u4FE1\u606F\uFF1A\u662F\u5426\u767B\u5F55\uFF1A{{user.isLogin}}</p>{{# if user.isLogin}}\n    \u7528\u6237\u540D\u79F0\uFF1A{{user.userData.name}}  \u7528\u6237\u90AE\u7BB1\uFF1A{{user.userData.email}}\n{{/if}}\n</div>';
...
//store
function posts() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initalPostState;
